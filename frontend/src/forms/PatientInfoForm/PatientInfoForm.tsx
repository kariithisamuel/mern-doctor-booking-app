...
const PatientInfoForm = ({ hospitalId, pricePerNight }: Props) => {
  ...
  const onSubmit = (data: PatientInfoFormData) => {
    ...
    navigate(`/hospital/${hospitalId}/booking`);
  };
    ...
    <div className="flex flex-col p-4 bg-blue-200 gap-4">
      ...
      >
        <div className="grid grid-cols-1 gap-4 items-center">
          ...
          {isLoggedIn ? (
            <button className="bg-blue-600 text-white h-full p-2 rounded-xl font-bold hover:bg-blue-500 text-xl">
              Book Now
            </button>
          ) : (
            <button className="bg-blue-600 text-white h-full p-2 rounded-xl font-bold hover:bg-blue-500 text-xl">
